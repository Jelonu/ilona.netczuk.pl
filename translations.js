...
const translations = {
  pl: {
    ...
    hero: {
      ...
      description:
        'Pracuję w różnych dziedzinach takich jak UI-design, UX-design i Visual Identity. Zawsze w ścisłej współpracy z innymi designerami, programistami i klientami.',
  ...
  en: {
    ...
    hero: {
      ...
      description:
        'I work in different disciplines such as UI-design, UX-design and Visual Identity. Always in close collaboration with other designers, developers and clients.',
...
class LanguageSwitcher {
  ...
  updateButtonStates() {
    ...
    allButtons.forEach(button => {
      const isActive =
        (this.currentLang === 'pl' && button.id.includes('pl')) ||
